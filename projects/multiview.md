...
title: Multiview 3D reconstruction using Computer Vision technique for Computer-Aided Geometric Design Applications
permalink: projects/multiview
date: 2020
labels:
  - Smart Grid
  - Power Quality
  ...
  - Java
  - Grid Map
summary: Algorithms used are Surface Motion for Multi-view Reconstruction and Disparity Mapping
---

<img class="ui image" src="{{ site.baseurl }}/images/multiview.jpg">
