...
title: Parallelizing Machine Learning and Statistical algorithms for Stock Price Prediction
...
labels:
  ...
  - Java
  - Grid Map
summary: Algorithms used Moving average, Auto Regression, KNN, Linear Regression, ANN and used OpenMP NUMBA with lowest RMSE 2.1178 and time boost by 92.35% for 8 threads on NVIDIA GPU
---

<img class="ui image" src="{{ site.baseurl }}/images/stock.jpg">
